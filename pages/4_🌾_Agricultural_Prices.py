...
st.write(""" The war has disrupted the supply chain of agricultural products, leading to a decrease in the availability of certain commodities and an increase in their prices.
...
st.write(""" European countries, in particular, have been hit hard by the rise in agricultural price index as a result of this conflict.
One of the main reasons for this is the fact that Russia was a major importer of agricultural products from Europe before the conflict began. the conflict has disrupted trade routes between Europe and Asia, making it more difficult and expensive for European countries to export their agricultural products to markets in Asia. This has led to a glut of produce on the European market, further driving down prices.
...
* The Russian invasion of Ukraine has significantly disturbed global agricultural markets in 2022
* The average price of goods and services currently consumed in agriculture for the EU as a whole increased by 35% for the same ‘basket’ of inputs
* Russia banned imports of certain agricultural products from the EU ,This has led to an oversupply of these products in the EU market
* Countries such as Poland, which relied heavily on exports to Russia before the conflict, have been particularly hard hit by the drop in demand  
* Countries such as Lithuania, Latvia, and Estonia, which are heavily dependent on agriculture for their economies, have also been significantly impacted by the rise in agricultural prices
